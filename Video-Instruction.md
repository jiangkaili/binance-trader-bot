# Video tutorial on how to setup the binance_grid_trader

## softwares requirements.
1. install pycharm, go to the website and download it: https://www.jetbrains.com/pycharm/download/
2. install anaconda, url: https://www.anaconda.com/products/distribution

remember to click "add conda to your path", we need to use the conda in
terminal. If you encounter conda not found, check out this link: https://stackoverflow.com/questions/35246386/conda-command-not-found


## download the codes

download the codes from github:
https://github.com/51bitquant/binance_grid_trader.git 

## create python environment and configure project's interpreter

use the anaconda to create a virtual environment, here we create a
virtual env name trader, you can use any name you like:
