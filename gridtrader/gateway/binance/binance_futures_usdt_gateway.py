...
from gridtrader.api.rest import Request, RestClient, Response
...
class BinanceFuturesUsdtGateway(BaseGateway):
    """
    Binance USDT, BUSD future gateway
    """

    default_name: str = "Futures"
...
class BinanceUsdtRestApi(RestClient):
    ...
    def __init__(self, gateway: BinanceFuturesUsdtGateway) -> None:
        """init"""
        super().__init__()

        self.gateway: BinanceFuturesUsdtGateway = gateway
